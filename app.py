...
st.subheader('Data From Year 2005 - 2021')
...
st.caption("When the 100MA line is above the 200MA line, it indicates an uptrend, while when the 100MA line is below the 200MA line, it indicates a downtrend.")
ma100 = df.Close.rolling(100).mean()
